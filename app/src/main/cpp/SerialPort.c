...
Java_com_skylin_mavlink_connection_serial_android_1serialport_1api_SerialPort_open(JNIEnv *env,
																				   jclass type,
																				   jstring path,
																				   jint baudrate,
																				   jint flags,
...
Java_com_skylin_mavlink_connection_serial_android_1serialport_1api_SerialPort_close(JNIEnv *env,
																					jobject instance) {
